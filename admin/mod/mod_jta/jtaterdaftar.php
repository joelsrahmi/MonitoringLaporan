...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="span4 chosen-select" name="penyunting" id="penyunting">
					<option></option>
					<?php
	...
	if (isset($_POST[simpan])){
		...
		id_dosen='$_POST[penyunting]' WHERE pid='$_POST[id]'");
	...
	<tbody>
	 <?php
	 	$qry = mysql_query("SELECT a.*, b.* FROM penugasan a 
		  JOIN mahasiswa b ON a.nkel=b.nkel
		  WHERE a.status='0'
	      ...
	      <td class='center'>
            <div class='inline position-relative'>
              ...
              <ul class='dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close'>
                  <li><a href='?page=$page&act=terima&id=$d[pid]' class='tooltip-success' data-rel='tooltip' data-original-title='Terima'>
