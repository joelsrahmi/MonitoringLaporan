	...
	<body>
		<div class="navbar" id="navbar">
			...
			<div class="navbar-inner">
					...
					<ul class="nav ace-nav pull-right">
						...
						?>
							...
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="../images/favicon.png" alt="<?php echo $_SESSION['sesNama'];?>">
				...
				</div><!--/#ace-settings-container--><!--/.ace-nav-->
				</div><!--/.container-fluid-->
			</div><!--/.navbar-inner-->
		...
		<div class="main-container container-fluid">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav-list">
					<li><a href="#"><span class="menu-text"><center><?php echo date("Y");?> &copy; <?php echo $_CONFIG[syscopyright];?></center></span></a>
					</li>
				</ul>
