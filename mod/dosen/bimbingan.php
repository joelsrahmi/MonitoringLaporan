...
<?php
	...
	<?php
		...
		<tbody>
		 <?php
		 	$qry = mysql_query("SELECT a.*,b.*, c.* FROM konsultasi a
		 							  JOIN penugasan b ON a.pid=b.pid 
		 							  JOIN mahasiswa c ON b.nkel=c.nkel
			...
			while ($d = mysql_fetch_array($qry)){
		      ...
		      $mnama = getValue("mNama","mahasiswa","mid='$d[mid]'");
		      $kid=$d['kId'];
		      $st = $d['kBaca'];
		      $status = $arSt[$st];
		      ...
		      <td class='center'>$mnama</td>
		      <td class='center'>$ktgl</td>
		      <td class='center'>$d[judul]</td>
		      <td class='center'>$d[kKet]</td>
		      <td class='center'>
