...
if (empty($_SESSION['sesId'])){
	...
	$filename="Judul Buku Laporan KKN Yang Diterima $jthn $jjur.pdf";
	...
	$content = "
				...
				<hr>
				<br><p align='center'><b><u>Judul Buku Laporan KKN Yang Diterima<br>$jthn $jjur</u></b></p>
				<br>
				...
				<table cellpadding='0' border='0' cellspacing='0' align='center'>
					<tr>
						...
						<th align='center' width='180' style='border:1px solid #000; background-color: $_CONFIG[syscolor]; padding: 4px;'>Judul Buku Laporan</th>
						<th align='center' width='100' style='border:1px solid #000; background-color: $_CONFIG[syscolor]; padding: 4px;'>Penyunting</th>
					</tr>
			";
			$no = 0;
			$query = mysql_query("SELECT a.*,b.* FROM penugasan a
	      ...
	      $tgls = date("Y-m-d");
				...
				$content .= "<tr>
									...
									<td style='border:1px solid #000; padding: 4px;' width='100'>$d[judul]</td>
									<td style='border:1px solid #000; padding: 4px;' width='100'>$peny</td>
								</tr>";
			}			
			$content .= "
					</table>
